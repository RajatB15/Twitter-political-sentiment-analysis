...
def main():
	...
	public_tweetsb=api.get_tweets(query="REPUBLICANS",count=2000)
	public_tweetsc=api.get_tweets(query="DEMOCRATS",count=2000)
	...
	print("overall polarity of REPUBLICANS =")
	print(polb/countb)
	polbp=(polb/countb)
	print("overall polarity of DEMOCRATS =")
	print(polc/countc)
	polcp=(polc/countc)


	print("overall subjectivity of REPUBLICANS =")
	print(subb/countb)
	subbp=(subb/countb)
	print("overall subjectivity of DEMOCRATS =")
	print(subc/countc)
	subcp=(subc/countc)

	print("number of tweets analyzed having REPUBLICANS as keyword=")
	print(countb)
	print("number of tweets analyzed having DEMOCRATS as keyword=")
	print(countc)

	objects=('REPUBLICANS-SENTIMANT','DEMOCRATS-SENTIMENT','REPUBLICANS-SUBJECTIVITY','DEMOCRATS-SUBJECTIVITY')
	...
	plt.title('TWITTER POLITICS-USA')
	plt.show()
